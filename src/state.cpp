...
axisState axis[NUMBER_OF_ANALOG_INPUTS] = {
    { NOT_USED, 0, 0, 0, AXIS_MAX, false }, // Speed brake
    { NOT_USED, 1, 0, 0, AXIS_MAX, false }, // Throttle 1
    { NOT_USED, 2, 0, 0, AXIS_MAX, false }, // Throttle 2
    { NOT_USED, 3, 0, 0, AXIS_MAX, false }, // Flaps
    { PA1, NOT_USED, 0, 0, AXIS_MAX, false }, // Reverse 1
    { PA2, NOT_USED, 0, 0, AXIS_MAX, false }, // Reverse 2
    { NOT_USED, 5, 0, 0, AXIS_MAX, false }, // Trim
};

buttonState buttons[] = {
    { 10, 0, 0, 0 }, // GPB0 AT disconnect 1
